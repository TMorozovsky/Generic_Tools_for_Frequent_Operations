#ifndef GTFO_FILE_INCLUDED_TYPE_TRAITS_ARE_COMPARABLE_OP_N_EQ_HPP
#define GTFO_FILE_INCLUDED_TYPE_TRAITS_ARE_COMPARABLE_OP_N_EQ_HPP
...
namespace gtfo
{
    namespace _tt
    {
        namespace helpers
        {
            ...
            template<typename T, typename U, bool can_invoke_op_n_eq_on_t_and_u>
            struct impl_result_of_op_n_eq
            {
            };

            template<typename T, typename U>
            struct impl_result_of_op_n_eq<T, U, true>
            {
                typedef decltype( declval<T &>() != declval<U &>() ) type;
            };

            template<typename T, typename U>
            struct result_of_op_n_eq : impl_result_of_op_n_eq
                                       <
                                           T,
                                           U,
                                           can_invoke_op_n_eq<T, U>::value
                                       >
            {
            };
        }
        ...
        struct are_comparable_op_n_eq
        {
            template<typename V, typename W, bool can_invoke_op_n_eq_on_v_and_w>
            struct impl
            {
                static constexpr bool value = false;
            };
            ...
            struct impl<V, W, true>
            {
                static constexpr bool value = can_be_used_in_boolean_context
                                              <
                                                  typename helpers::result_of_op_n_eq
                                                  <
                                                      V,
                                                      W
                                                  >::type
...
#endif // GTFO_FILE_INCLUDED_TYPE_TRAITS_ARE_COMPARABLE_OP_N_EQ_HPP
