...
namespace gtfo
{
    ...
    <
        ...
        >::value,
        decltype(::std::count_if(_tt::declval< InputIterator >(),
    ...
    count_if(InputIterator  it_begin,
             ...
             UnaryPredicate pred)
    {
        return ::std::count_if(::gtfo::move(it_begin),
                               ::gtfo::move(it_end),
                               ::gtfo::move(pred));
    }
    ...
    <
        ...
        >::value,
        decltype(::std::count_if(_tt::declval< typename _tt::iterator_of_range< Range >::type >(),
