...
namespace
{
    ...
    static const std::vector<int> vi = make_12345();
    ...
    void test_part1()
    {
        ...
        GTFO_TEST_ASSERT_EQ(gtfo::accumulate(vi.begin() + 1, vi.end() - 1, -10000, gtfo::plus()), -9991)
    }
    ...
    void test_part2()
    {
        ...
        GTFO_TEST_ASSERT_EQ(gtfo::accumulate(vi,                100, gtfo::plus()),               115)
        GTFO_TEST_ASSERT_EQ(gtfo::accumulate(make_12345(),      100, gtfo::plus()),               115)
        GTFO_TEST_ASSERT_EQ(gtfo::accumulate(rev(vi),           100, gtfo::plus()),               115)
        GTFO_TEST_ASSERT_EQ(gtfo::accumulate(rev(make_12345()), 100, gtfo::plus()),               115)
    }
    ...
    void test_part3()
    {
        ...
        GTFO_TEST_ASSERT_NEAR_E3(gtfo::accumulate(c_array, c_array + 2, 5.f, gtfo::plus()),       8.f)
        GTFO_TEST_ASSERT_NEAR_E3(gtfo::accumulate(c_array),                                       15.f)
        GTFO_TEST_ASSERT_NEAR_E3(gtfo::accumulate(c_array, 5.f),                                  20.f)
        GTFO_TEST_ASSERT_NEAR_E3(gtfo::accumulate(c_array, 5.f, gtfo::multiplies()),              600.f)
